  ...
  return (
    <header className=" text-4xl w-screen   font-semibold text-blak">
            <div className="py-12 overflow-x-hidden">
              <Navbar/>
                <div className='py-10  px-4 mt-10 md:w-4/5 mx-auto'>
                    <div className='flex justify-evenly'>
                        <div className='w-3/5 border-b-4 border-black p-4 '>
                            <h1 className='text-6xl font-light leading-tight my-auto'>Leading your digital transformation <span className=' font-medium font-SG'>Remotely</span></h1>
                        </div>
                        <div className='bg-gradient-to-r from-rose-200 to-orange-200 p-2 rounded-xl w-72'>
